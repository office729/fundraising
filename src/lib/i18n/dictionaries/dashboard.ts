...
export const DASHBOARD_DICT = {
  ro: {
    ...
    nav: {
      home: "Acasă",
      sectionRelatii: "Persoane și organizații",
      ...
      sectionFinanciar: "Strângere de fonduri",
      donatii: "Donații",
      ...
      rfm: "RFM & segmentare",
      sectionOperare: "Lucru",
      sectionPlatforma: "Platformă",
  ...
  en: {
    ...
    nav: {
      home: "Home",
      sectionRelatii: "People & organisations",
