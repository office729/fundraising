  ...
  ro: {
    crmSetari: {
      ...
      integrariList: {
        ...
        zapier: { nume: "Zapier", descriere: "Automatizări între platformă și mii de aplicații, fără cod (Zaps, webhook-uri)." },
  ...
  en: {
    crmSetari: {
      ...
      integrariList: {
        ...
        zapier: { nume: "Zapier", descriere: "No-code automations between the platform and thousands of apps (Zaps, webhooks)." },
