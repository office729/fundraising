...
export const CINE_SUNTEM_DICT = {
  ro: {
    ...
    paragrafe: [
      ...
      "Platforma are la bază experiența de peste 14 ani a lui Vlad Plăcintă, președintele Asociației „Salvează o inimă”, dar și munca unei echipe implicate zi de zi în comunicare, fundraising, relația cu donatorii și companiile. Împreună, am contribuit la strângerea a peste 28 de milioane de euro și la susținerea a sute de campanii umanitare.",
    ...
    diferentiatoriSubtitlu: "Peste 700 de campanii reușite și 28 milioane de euro strânși.",
    diferentiatori: [
  ...
  en: {
    ...
    diferentiatoriSubtitlu: "700+ successful campaigns and €28 million raised.",
    diferentiatori: [
