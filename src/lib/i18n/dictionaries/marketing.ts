  ...
  ro: {
    ...
    platforma: {
      ...
      items: [
        ...
        { n: "05", t: "Formularul 230", d: "Link propriu pentru ONG-ul tău, unde donatorii completează online Formularul 230 pentru redirecționarea a 3,5% din impozit, plus o campanie anuală de reamintire prin email." },
  ...
  en: {
    ...
    platforma: {
      ...
      items: [
        ...
        { n: "05", t: "Form 230", d: "A dedicated link for your NGO where donors fill in Form 230 online to redirect 3.5% of their income tax, plus an annual email reminder campaign." },
