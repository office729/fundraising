...
function AppleMark() {
  return (
    <svg width="14" height="17" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        fill="white"
...
// Aceleași dimensiuni ca butonul verde „Donează acum" (w-full, rounded-lg,
// px-5 py-2.5, text-[13.5px] font-bold) — cerut explicit, unul sub altul, nu
// grupate 2x2.
const badgeCls =
  "flex w-full items-center justify-center gap-2 rounded-lg px-5 py-2.5 text-[13.5px] font-bold shadow-sm transition hover:-translate-y-0.5 hover:shadow-md active:translate-y-0";
...
export function PaymentBadges() {
  return (
    <div className="flex flex-col gap-2">
      ...
      <button type="button" className={`${badgeCls} border border-line bg-panel`}>
        <span style={{ fontFamily: "Georgia, serif" }} className="text-[15px] italic">
