...
export default function CrmSetariPage() {
  ...
  const INTEGRARI = [dict.integrariList.stripe, dict.integrariList.mailchimp, dict.integrariList.newsman, dict.integrariList.theMarketer, dict.integrariList.brevo, dict.integrariList.googleCalendar, dict.integrariList.make, dict.integrariList.zapier, dict.integrariList.canva];
